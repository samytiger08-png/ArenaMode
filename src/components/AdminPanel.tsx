                          ...
                          <td className="py-2.5 text-center">
                            <div className="flex flex-col">
                              <span className="bg-[#F5F2ED] text-gray-600 text-[10px] px-2 py-0.5 rounded-full font-bold border inline-block mx-auto">
                                {p.category === 'men_swim_shorts' ? 'Shorts Homme' : 'Maillot Femme'}
                              </span>
                            </div>
                          </td>
                    ...
                    {products.filter((p) => p.stock <= 5).map((p) => (
                      <div key={p.id} className="flex gap-3 bg-orange-50/50 p-3 rounded-xl border border-orange-100">
                        ...
                        <div className="flex-1 text-left space-y-0.5">
                          ...
                          <span className="text-[9px] font-bold text-gray-400 tracking-wider block uppercase">{p.category === 'men_swim_shorts' ? 'Shorts Homme' : 'Maillots Femme'}</span>
                        </div>
                    ...
                    {products.map((p) => (
                      <div key={p.id} className="flex items-center justify-between gap-3 p-2 bg-gray-50/60 rounded-xl border border-gray-100">
                        <div className="flex-1 text-left min-w-0">
                          ...
                          <span className="text-[9px] text-gray-400 uppercase font-bold tracking-wider">{p.category === 'men_swim_shorts' ? 'Shorts' : 'Maillot'}</span>
                        </div>
